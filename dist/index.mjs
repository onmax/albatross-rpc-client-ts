        ...
        next: (callback) => {
          ws.onmessage = (event2) => __async(this, null, function* () {
            ...
            if (event2.data instanceof Blob) {
              payload = this.textDecoder.decode(yield event2.data.arrayBuffer());
            } else if (event2.data instanceof ArrayBuffer) {
              payload = this.textDecoder.decode(event2.data);
            } else {
              payload = event2.data;
            }
            callback(payload);
...
var BlockchainClient = class extends Client {
   ...
   */
  getSlotAt(_0) {
    return __async(this, arguments, function* ({ blockNumber, offsetOpt }) {
  ...
  */
   ...
   */
  subscribeForValidatorElectionByAddress(_0) {
    return __async(this, arguments, function* ({ address }) {
  ...
  subscribeForLogsByAddressesAndTypes() {
    return __async(this, arguments, function* (p = { addresses: [], types: [] }) {
