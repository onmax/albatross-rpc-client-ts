...
var PolicyClient = class {
  ...
  async getEpochAt(blockNumber, options = DEFAULT_OPTIONS) {
    return this.client.call({ method: "getEpochAt", params: [blockNumber] }, options);
  }
  /**
  ...
  async getEpochIndexAt(blockNumber, options = DEFAULT_OPTIONS) {
    return this.client.call({ method: "getEpochIndexAt", params: [blockNumber] }, options);
  }
  /**
   * Returns the batch number at a given `block_number` (height)
   */
  async getBatchAt(blockNumber, options = DEFAULT_OPTIONS) {
    return this.client.call({ method: "getBatchAt", params: [blockNumber] }, options);
  }
  /**
  ...
  async getBatchIndexAt(blockNumber, options = DEFAULT_OPTIONS) {
    return this.client.call({ method: "getBatchIndexAt", params: [blockNumber] }, options);
  }
  /**
